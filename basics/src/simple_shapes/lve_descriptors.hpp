...
class LveDescriptorPool {
  public:
    ...
    LveDescriptorPool(LveDevice& lveDevice,
                      uint32_t maxSets,
...
class LveDescriptorWriter {
  public:
    ...
    LveDescriptorWriter& writeBuffer(uint32_t binding, VkDescriptorBufferInfo const* bufferInfo);
    LveDescriptorWriter& writeImage(uint32_t binding, VkDescriptorImageInfo const* imageInfo);
