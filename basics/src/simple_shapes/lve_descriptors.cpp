...
LveDescriptorSetLayout::Builder::addBinding(uint32_t binding,
...
LveDescriptorPool::LveDescriptorPool(LveDevice& lveDevice,
                                     uint32_t maxSets,
...
{
    vkFreeDescriptorSets(lveDevice.device(),
                         descriptorPool,
