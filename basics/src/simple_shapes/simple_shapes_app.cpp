...
void SimpleShapesApp::recreateSwapChain()
{
...
void SimpleShapesApp::createPipeline()
{
...
void SimpleShapesApp::createCommandBuffers()
{
...
void SimpleShapesApp::freeCommandBuffers()
{
...
void SimpleShapesApp::drawFrame()
{
    uint32_t imageIndex;
